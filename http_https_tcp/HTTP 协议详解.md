...
*kame* *2017/11/12*  69  *http*

## [#](http://www.liuwq.com/views/linux基础/http协议.html#http-的特性)HTTP 的特性

- HTTP 协议构建于 TCP/IP 协议之上，是一个应用层协议，默认端口号是 80
- HTTP 是**无连接无状态**的

## [#](http://www.liuwq.com/views/linux基础/http协议.html#http-报文)HTTP 报文

### [#](http://www.liuwq.com/views/linux基础/http协议.html#请求报文)请求报文
...
### [#](http://www.liuwq.com/views/linux基础/http协议.html#post-提交数据的方式)POST 提交数据的方式
